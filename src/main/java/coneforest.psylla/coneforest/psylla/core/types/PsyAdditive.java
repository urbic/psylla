...
/**
*	A representation of {@code additive}, a type of object that is an operand of arithmetic
	...
	extends PsyObject
{
	...
	*
	*   @return {@link PsyBoolean#TRUE} if this object represents a zero value, and {@link
	*   PsyBoolean#FALSE} otherwise.
	*/
	...
	*
	*   @return {@link PsyBoolean#TRUE} if this object represents a non-zero value, and {@link
	*   PsyBoolean#FALSE} otherwise.
	*/
