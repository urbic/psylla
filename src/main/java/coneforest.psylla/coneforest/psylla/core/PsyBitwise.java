	...
	extends PsyLogical<T>
{
	...
	*		given distance} If the distance is negative, the left shift is preformed. If the
	*		distance is positive, the right shift is preformed. If the distance is zero, returns
	*		this.
	*
