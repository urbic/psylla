	...
	extends junit.framework.TestCase
{
	...
	{
		final String root=System.getProperty(coneforest.psi.tools.ant.PsyllaUnit.class.getName()+".testName");
		...
		throws java.io.IOException
	{
		...
		try
		{
			coneforest.psi.Psylla.main(cmdLine);
